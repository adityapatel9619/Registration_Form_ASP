<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="NewRegistrationForm.Registration" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Registration Form(Advanced Controls)</title>
    <style type="text/css">  
    .auto-style1 {  
         width: 100%;  
          }  
...
<body>
  ...
  <table class="auto-style1">  
    ...
    <td>  
    <asp:CheckBox ID="CheckBox1" runat="server" Text="Web Development" />  
    <asp:CheckBox ID="CheckBox2" runat="server" Text="Deep Learning" />  
    <asp:CheckBox ID="CheckBox3" runat="server" Text="Digital Marketing" />  
    </td>  
    </tr>  
    <tr>  
    <td>  
